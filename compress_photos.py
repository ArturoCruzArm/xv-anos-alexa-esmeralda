...
# -*- coding: utf-8 -*-
"""
Script para comprimir fotos de XV años de Alexa Esmeralda a formato WebP
"""
...
# Configuración
SOURCE_DIR = r"F:\2025\11\15\SI\SI\descomprimidas"
OUTPUT_DIR = r"C:\Users\foro7\xv-anos-alexa-esmeralda\images"
...
def main():
    ...
    print("="*60)
    print("  COMPRESOR DE FOTOS - XV ANOS ALEXA ESMERALDA")
    print("="*60)
    print()
    ...
    for i, photo_path in enumerate(photos, 1):
        # Nombre de salida: foto0001.webp, foto0002.webp, etc.
        output_name = f"foto{str(i).zfill(4)}.webp"
